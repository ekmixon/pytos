...
COMMON_LOGGER_NAME = f"{LOGGER_NAME_PREFIX}COMMON"
MAIL_LOGGER_NAME = f"{LOGGER_NAME_PREFIX}MAIL"
HELPERS_LOGGER_NAME = f"{LOGGER_NAME_PREFIX}HELPERS"
REPORTS_LOGGER_NAME = f"{LOGGER_NAME_PREFIX}REPORTS"
REQUESTS_LOGGER_NAME = f"{LOGGER_NAME_PREFIX}REQUESTS"
SQL_LOGGER_NAME = f"{LOGGER_NAME_PREFIX}SQL"
THIRD_PARTY_LOGGER_NAME = f"{LOGGER_NAME_PREFIX}THIRD_PARTY"
XML_LOGGER_NAME = f"{LOGGER_NAME_PREFIX}XML"
WEB_LOGGER_NAME = f"{LOGGER_NAME_PREFIX}WEB"
